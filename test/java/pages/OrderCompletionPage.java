...
public class OrderCompletionPage extends LoadableComponent<OrderCompletionPage>{
	...
	@SuppressWarnings("unused")
	private LoadableComponent<FinalConfirmationOnOrderPage> finalConfirmationOnOrderPage;
	...
	public OrderCompletionPage(WebDriver driver, LoadableComponent<FinalConfirmationOnOrderPage> finalConfirmationOnOrderPage) {
		this.driver = driver;
